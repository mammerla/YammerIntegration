...
{
    public enum MessageThreading
    {
        /// <summary>
        /// Returns the first message in a thread in a message query.
        /// </summary>
        ThreadStarterOnly,

        /// <summary>
        /// Returns the first message in a thread plus the two most recent messages.
        /// </summary>
        Extended
    }
}